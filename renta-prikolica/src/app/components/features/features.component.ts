...
export class FeaturesComponent implements AfterViewInit {
  ...
  features = [
    { icon: '✅', title: 'Registrovane Prikolice', desc: 'Sve naše prikolice su tehnički ispravne, registrovane i osigurane.' },
    ...
    { icon: '🛡️', title: 'Osiguranje Uključeno', desc: 'Svaka prikolica dolazi sa osnovnim osiguranjem od odgovornosti.' },
    { icon: '📞', title: 'Stručna Podrška', desc: 'Tim stručnjaka spreman da Vam pomogne u odabiru prave prikolice.' }
  ];

  stats = [
    { value: '500+', label: 'Zadovoljnih Klijenata' },
    { value: '4', label: 'Tipa Prikolica' },
